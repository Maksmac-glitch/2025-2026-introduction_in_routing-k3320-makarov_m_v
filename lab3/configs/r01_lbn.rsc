...
/ip address
add address=10.0.0.18/30 interface=ether2 comment="LBN<->MSK"
add address=10.0.0.21/30 interface=ether3 comment="LBN<->NY"
add address=10.0.0.26/30 interface=ether4 comment="LBN<->HKI (extra)"
